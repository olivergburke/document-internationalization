...
var jsxRuntime = require("react/jsx-runtime"), icons = require("@sanity/icons"), ui = require("@sanity/ui"), react = require("react"), sanity = require("sanity"), sanityPluginUtils = require("sanity-plugin-utils"), uuid = require("@sanity/uuid"), router = require("sanity/router"), structure = require("sanity/structure"), desk = require("sanity/desk"), mutator = require("@sanity/mutator"), styledComponents = require("styled-components"), sanityPluginInternationalizedArray = require("sanity-plugin-internationalized-array");
...
function useOpenInCurrentPane(id, type) {
  const routerContext = react.useContext(router.RouterContext), { routerPanesState, groupIndex } = desk.usePaneRouter();
  return react.useCallback(() => {
    if (!routerContext || !id || !type)
      return;
    if (!routerPanesState.length) {
